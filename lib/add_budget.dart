...
class Budget {
  ...
  Budget(String this.judul, int this.nominal, String this.tipe,
      String this.date);
}
                      ...
                      TextButton(
                        ...
                        onPressed: () {
                          if (_formKey.currentState!.validate()) {
                            listBudget.add(Budget(judulBudget, nominal, jawabanPilihan, dateinput.text));
                            showDialog(
                              context: context,
                              builder: (context) {
                                return Dialog(
                                  ...
                                  child: ListView(
                                    ...
                                    shrinkWrap: true,
                                    children: <Widget>[
                                      const Center(child: Text('Data sudah berhasil dibuat')),
